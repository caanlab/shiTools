function [MaxClusterSize,MaxT] = shiSpmAlphaSim_OneSamplePerm(Img, WorkingDir, MaskImg, OutTxt, ConnectDef, Voxel_P, n_Iteration)
...
for iter = 1:n_Iteration
    ...
    shiSpmAlphaSim_OneSamplePerm_OneSampleRegress(PermDir,Img,Cov(:,iter));
    ...
    for p = 1:numel(Voxel_T)
        ...
        MaxClusterSize(iter,p) = shiSpmAlphaSim_OneSamplePerm_MaxCluster(Y_TImg_masked,ConnectDef);
    end
    ...
    shiSpmAlphaSim_OneSamplePerm_ResetWorkingDir(PermDir);
