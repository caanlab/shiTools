function [MaxClusterSize_Pos,MaxClusterSize_Neg,MaxT_Pos,MaxT_Neg] = shiSpmAlphaSim_TwoSamplePerm_par(Img1,Img2, WorkingDir, MaskImg, OutTxt, ConnectDef, Voxel_P, n_Iteration)
...
%     axis off
    ...
    shiSpmAlphaSim_TwoSamplePerm_TwoSampleT(PermDir{iter,1},IMG_1{iter},IMG_2{iter});
